                ...
                <div className="row g-4">
                    ...
                    <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div className="service-item d-flex flex-column text-center rounded">
                            ...
                            <p className="m-0">
                                Enhancing visibility and driving traffic through strategic
                                techniques for better search engine rankings and exposure.
                            </p>
                            <a className="btn btn-square" href="">
                                <i className="fa fa-arrow-right" />
                            </a>
                    ...
                    <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div className="service-item d-flex flex-column text-center rounded">
                            ...
                            <p className="m-0">
                                Amplifying brands through strategic online engagement, content, and
                                campaigns across social platforms for maximum impact.
                            </p>
                            <a className="btn btn-square" href="">
                                <i className="fa fa-arrow-right" />
                            </a>
                    ...
                    <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div className="service-item d-flex flex-column text-center rounded">
                            ...
                            <p className="m-0">
                                Maximize outreach and engagement with strategic email campaigns for
                                effective customer communication and brand growth.
                            </p>
                            <a className="btn btn-square" href="">
                                <i className="fa fa-arrow-right" />
                            </a>
